...
public class StorageImporter {
  ...
  public Map<String, List<ModelBody>> importData(File file) {
    ...
    Preconditions.checkArgument(
        file.exists(), "Failed to import data from " + file.getName() + " cause it doesn't exist!");
      ...
      while (!reader.isEmpty()) {
        ...
        for (String variantDatum : variantData) {
          JsonObject jsonObject =
              StorageInitializer.getInstance().getGson().fromJson(variantDatum, JsonObject.class);
