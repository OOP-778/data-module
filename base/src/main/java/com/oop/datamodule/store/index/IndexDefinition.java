package com.oop.datamodule.store.index;

import com.oop.datamodule.store.index.comparison.ComparisonPolicy;
import com.oop.datamodule.store.index.comparison.DefaultComparisonPolicy;
import com.oop.datamodule.store.index.reducer.Reducer;
...
public final class IndexDefinition<K, V> {
   ...
   * com.oop.datamodule.store.index.comparison.string.CaseInsensitiveComparisonPolicy} when
