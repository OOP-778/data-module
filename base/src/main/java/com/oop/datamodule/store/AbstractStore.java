package com.oop.datamodule.store;

import com.oop.datamodule.store.index.Index;
import com.oop.datamodule.store.index.IndexDefinition;
import com.oop.datamodule.store.index.IndexException;
import com.oop.datamodule.store.index.IndexManager;
import com.oop.datamodule.store.query.IndexMatch;
import com.oop.datamodule.store.query.Operator;
import com.oop.datamodule.store.query.Query;
import com.oop.datamodule.store.query.QueryDefinition;
import com.oop.datamodule.store.reference.Reference;
import com.oop.datamodule.store.reference.ReferenceManager;
