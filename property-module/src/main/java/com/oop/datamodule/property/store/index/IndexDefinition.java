package com.oop.datamodule.property.store.index;

import com.oop.datamodule.property.store.index.comparison.ComparisonPolicy;
import com.oop.datamodule.property.store.index.comparison.DefaultComparisonPolicy;
...
public final class IndexDefinition<K, V> {
   ...
   * com.oop.datamodule.property.store.index.comparison.string.CaseInsensitiveComparisonPolicy} when
